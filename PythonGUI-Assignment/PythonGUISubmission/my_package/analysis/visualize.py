...
def plot_visualization(image, pred_boxes, pred_masks, pred_class, pred_score, save_location='.', output_name='output.png', addBoundingBoxes=True, addMasks=True, save_image=False, show_image=False):
  '''
